    ...
    <div className="max-w-7xl mx-auto px-6 space-y-8">
      ...
      <Card className="border border-gray-200 shadow-sm">
        <CardHeader className="pb-4">
          <CardTitle className="text-xl font-semibold text-gray-900">Welcome to Pro Tools</CardTitle>
          <CardDescription className="text-gray-600">
            Start here to learn how to use Pro Tools' advanced data tools.
          </CardDescription>
        </CardHeader>
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-1">Explore projects shared by the Pro Tools community.</p>
          </div>
        </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-1">Your latest actions and updates across Pro Tools.</p>
          </div>
